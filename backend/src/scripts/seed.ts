...
async function main() {
  ...
  console.log({
    admin: 'admin@uts.edu.co / Uts12345!',
    coordinator: 'coordinador@uts.edu.co / Uts12345!',
    professor: 'docente@uts.edu.co / Uts12345!',
    student: 'estudiante@uts.edu.co / Uts12345!',
  });
